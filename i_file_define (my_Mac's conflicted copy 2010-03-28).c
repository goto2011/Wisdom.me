...
{
  return i_file_route_max_length;
}

/*****************************************************************************
 Prototype    : i_set_file_route_max_length
 Description  : 设置文件系统路径最大长度
...
*****************************************************************************/
void i_set_file_route_max_length(uint32 new_max_length)
{
  i_file_route_max_length = new_max_length;
}
...
{
  i_file_name_max_length = new_max_length;
}
